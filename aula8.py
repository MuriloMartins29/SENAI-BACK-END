...
def accepted():
    messagebox.showinfo('Meu amor', 'Eu te amo, Lanchinho mais tarde?')
...
# image = tk.PhotoImage(file='foto.png', width=50, height=50)
# w = tk.Label(root, image=image)
# w.pack()
...
text_id.pack()
button_1 = tk.Button(root, text='Não', bg='#ffb3c1', command=denied, relief=RIDGE, bd=3, font=('Montserrat',6, 'bold'))
